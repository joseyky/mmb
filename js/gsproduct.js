$(function() {
    ...
    function getGsShop() {
        $.get("http://139.199.157.195:9090/api/getgsshop", function(res) {
            var data = res.result;
            ShopData = data;
            // <li class="on"><a href="#shop" data-shopid="0">一号店<i></i></a></li>  加载店铺标题
            ...
            $(".filter ul").on("click", ">li", function(e) {
    ...
    function getArea() {
        $.get("http://139.199.157.195:9090/api/getgsshoparea", function(res) {
            var data = res.result;
            AreaData = data;
            //  <li class=""><a href="#" data-areaid="6">西北（宁夏、新疆等）</a></li>
            var arr = [];
            $.each(data, function(i, v) {
